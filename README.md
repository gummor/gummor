...
Built a **Random Forest** model, wrapped it in a **FastAPI** RESTful service, and containerized the entire environment with **Docker**.
...
* `Big Data` `Clustering` `Dimensionality Reduction` `Bioinformatics`
